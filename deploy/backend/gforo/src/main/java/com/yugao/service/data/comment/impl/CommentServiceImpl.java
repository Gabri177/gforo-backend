package com.yugao.service.data.comment.impl;
...
import com.yugao.mapper.comment.CommentMapper;
...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public Integer selectCountByCreateTime(LocalDateTime start, LocalDateTime end) {

        return commentMapper.selectCountByCreateTime(start, end);
    }
